...
public class CalculatorBackUp{
	...
	public static void main(String[] args) {
		int choice;   //Variable for the user choice in the menu
		Float[] inputFloats=new Float[2];
		
		//do-while loop so that the user can use the functionality till he wishes to exit the program by
		//selecting option 5
		do{
			//Create Scanner
			...
			System.out.println("\n\nPress enter to continue...");//This would get displayed after every operation's result is displayed
			input.nextLine();					  //In order to return to a new line
		}while(true);						  //Loop runs till the user selects option 5 
	}
	
	//Static method to display the menu for user
	...
	//Method to ask the user for selecting option between 1-5.This method takes Scanner input as input parameter
	// and returns users choice as an integer 
	
	public static int getUserChoice(){
		displayMenu();						  //Invoke method Menu to display the options
		int choiceInt;
	...
	public static Float[] getTwoFloats(int choice){
		...
		//This switch case displays the message for entering the float values as per user choice		
			...
			do{
				...
				//numbers entered by the user cannot be zero if the choice is 4 for division.
	...
	private static boolean isValidInput(String[] myString, Float[] myFloat, int choice) {
